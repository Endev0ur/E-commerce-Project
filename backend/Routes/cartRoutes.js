...
/*
@route : create a cart : POST /api/cart
...
/*
  ...
  route PUT /api/cart
  desc Update product quantity int he cart for a guest or logged in user
  access public
...
/* 
  ...
  route GET /api/cart
  desc get loggedin user's or guest user cart
  access public
    ...
    if(guestCart){
      ...
      if(userCart){
        ...
        try{
          ...
          console.error("Error dleeting guest cart : " , err);
      ...
      if(userCart){
        //guest cart has already been merged simply return the usercart\
