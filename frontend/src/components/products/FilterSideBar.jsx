...
const FilterSideBar = () => {
  ...
  const brands = ["Urban Threads" , "Modern Fit" , "Street Style" , "Breach Breeze" , "Fashionist" , "ChicStyle"]
  ...
  const updateURLParams = (newFilters) => {
    ...
    navigateTo(`?${params.toString()}`);//category=Bottm+Wear&size=XS LIKE THAT
  }
        ...
        <div className="flex flex-wrap gap-2">
          {
            colors.map((color)=>(
              <button 
                ...
                className={`w-8 h-8 rounded-full border-gray-300 cursor-pointer transition hover:scale-105 ${filters.color===color ? "rind-2 ring-blue-500":""}`}
