        ...
        <div className="p-4 sm:p-6 rounded-lg border">
          ...
          <div className="flex flex-col sm:flex-row justify-between mb-8">
            ...
            <div className="flex flex-col items-start sm:items-end mt-4 sm:mt-0">
              <span className={`${orderDetails.isPaid ? "bg-green-100 text-green-700" : "bg-red-100 text-red-900"} px-3 py-1 rounded-full text-sm font-medium mb-2`}>
                {orderDetails.isPaid?"Approved":"Pending"}
              </span>

              <span className={`${orderDetails.isDelivered ? "bg-green-100 text-green-700" : "bgyellow-100 text-yellow-900"} px-3 py-1 rounded-full text-sm font-medium mb-2`}>
